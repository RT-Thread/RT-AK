...
static uint8_t g_fb_buf[OMV_RAW_BUF_SIZE*2] __attribute__((aligned(64)));
static framebuffer_t _fb_framebuffer0={0,0,0,0,0,0,0,0,OMV_RAW_BUF_SIZE,g_fb_buf};
// static framebuffer_t _fb_framebuffer1={0,0,0,0,0,0,0,NULL,g_ai_buf_out};
framebuffer_t *framebuffer = &_fb_framebuffer0;

static uint8_t g_jpg_buf[OMV_JPEG_BUF_SIZE] __attribute__((aligned(64)));
static jpegbuffer_t _jpeg_fb_framebuffer={0,0,0,0,0,{},g_jpg_buf};
jpegbuffer_t* jpeg_framebuffer = &_jpeg_fb_framebuffer;
