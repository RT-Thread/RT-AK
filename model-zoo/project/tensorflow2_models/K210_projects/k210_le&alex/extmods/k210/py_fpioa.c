...
#define USABLE_FUNC_NUM FUNC_CLK_I2C2

typedef struct _k210_fpioa_obj_t
{
	mp_obj_base_t base;
} k210_fpioa_obj_t;

const mp_obj_type_t k210_fpioa_type;

int io_config_used(int io_num);

STATIC mp_obj_t k210_set_function(size_t n_args, const mp_obj_t *pos_args, mp_map_t *kw_args)
{
	enum
	{
		ARG_pin,
	...
	if (io_config_used(pin_num))
	{	
		mp_printf(&mp_plat_print, "Warnging: this pin is used and will be reset\n");
		if (fpioa_set_function(pin_num, FUNC_RESV1) != 0) return mp_const_false;
		// return mp_const_false;
	}

	if (fpioa_set_function(pin_num, func_num) != 0)
	{
		mp_printf(&mp_plat_print, "Can not set fpioa\n");
...
STATIC MP_DEFINE_CONST_FUN_OBJ_KW(k210_set_function_obj, 2, k210_set_function);

STATIC mp_obj_t k210_get_io_by_function(size_t n_args, const mp_obj_t *pos_args, mp_map_t *kw_args)
{
	enum
	{
		ARG_func,
...
STATIC MP_DEFINE_CONST_FUN_OBJ_KW(k210_get_io_by_function_obj, 0, k210_get_io_by_function);

STATIC mp_obj_t k210_fpioa_make_new()
{

	k210_fpioa_obj_t *self = m_new_obj(k210_fpioa_obj_t);
	self->base.type = &k210_fpioa_type;

	return self;
}

STATIC const mp_rom_map_elem_t k210_fpioa_locals_dict_table[] = {
	// fpioa methods
	{MP_ROM_QSTR(MP_QSTR_set_function), MP_ROM_PTR(&k210_set_function_obj)},
	{MP_ROM_QSTR(MP_QSTR_get_io_by_function), MP_ROM_PTR(&k210_get_io_by_function_obj)},

	{MP_ROM_QSTR(MP_QSTR_JTAG_TCLK), MP_ROM_INT(FUNC_JTAG_TCLK)},
	{MP_ROM_QSTR(MP_QSTR_JTAG_TDI),  MP_ROM_INT(FUNC_JTAG_TDI)},
	{MP_ROM_QSTR(MP_QSTR_JTAG_TMS),  MP_ROM_INT(FUNC_JTAG_TMS)},
	{MP_ROM_QSTR(MP_QSTR_JTAG_TDO),  MP_ROM_INT(FUNC_JTAG_TDO)},
	{MP_ROM_QSTR(MP_QSTR_SPI0_D0), MP_ROM_INT(FUNC_SPI0_D0)},
	{MP_ROM_QSTR(MP_QSTR_SPI0_D1), MP_ROM_INT(FUNC_SPI0_D1)},
	{MP_ROM_QSTR(MP_QSTR_SPI0_D2), MP_ROM_INT(FUNC_SPI0_D2)},
	{MP_ROM_QSTR(MP_QSTR_SPI0_D3), MP_ROM_INT(FUNC_SPI0_D3)},
	{MP_ROM_QSTR(MP_QSTR_SPI0_D4), MP_ROM_INT(FUNC_SPI0_D4)},
	{MP_ROM_QSTR(MP_QSTR_SPI0_D5), MP_ROM_INT(FUNC_SPI0_D5)},
	{MP_ROM_QSTR(MP_QSTR_SPI0_D6),  MP_ROM_INT(FUNC_SPI0_D6)},
	{MP_ROM_QSTR(MP_QSTR_SPI0_D7),  MP_ROM_INT(FUNC_SPI0_D7)},
	{MP_ROM_QSTR(MP_QSTR_SPI0_SS0), MP_ROM_INT(FUNC_SPI0_SS0)},
	{MP_ROM_QSTR(MP_QSTR_SPI0_SS1), MP_ROM_INT(FUNC_SPI0_SS1)},
	{MP_ROM_QSTR(MP_QSTR_SPI0_SS2), MP_ROM_INT(FUNC_SPI0_SS2)},
	{MP_ROM_QSTR(MP_QSTR_SPI0_SS3), MP_ROM_INT(FUNC_SPI0_SS3)},
	{MP_ROM_QSTR(MP_QSTR_SPI0_ARB), MP_ROM_INT(FUNC_SPI0_ARB)},
	...
	{MP_ROM_QSTR(MP_QSTR_DRIVING_0), MP_ROM_INT(FPIOA_DRIVING_0)},
    {MP_ROM_QSTR(MP_QSTR_DRIVING_1), MP_ROM_INT(FPIOA_DRIVING_1)},
	{MP_ROM_QSTR(MP_QSTR_DRIVING_2), MP_ROM_INT(FPIOA_DRIVING_2)},
	{MP_ROM_QSTR(MP_QSTR_DRIVING_3), MP_ROM_INT(FPIOA_DRIVING_3)},
	{MP_ROM_QSTR(MP_QSTR_DRIVING_4), MP_ROM_INT(FPIOA_DRIVING_4)},
    {MP_ROM_QSTR(MP_QSTR_DRIVING_5), MP_ROM_INT(FPIOA_DRIVING_5)},
	{MP_ROM_QSTR(MP_QSTR_DRIVING_6), MP_ROM_INT(FPIOA_DRIVING_6)},
	{MP_ROM_QSTR(MP_QSTR_DRIVING_7), MP_ROM_INT(FPIOA_DRIVING_7)},
	{MP_ROM_QSTR(MP_QSTR_DRIVING_8), MP_ROM_INT(FPIOA_DRIVING_8)},
    {MP_ROM_QSTR(MP_QSTR_DRIVING_9), MP_ROM_INT(FPIOA_DRIVING_9)},
	{MP_ROM_QSTR(MP_QSTR_DRIVING_10), MP_ROM_INT(FPIOA_DRIVING_10)},
	{MP_ROM_QSTR(MP_QSTR_DRIVING_11), MP_ROM_INT(FPIOA_DRIVING_11)},
	{MP_ROM_QSTR(MP_QSTR_DRIVING_12), MP_ROM_INT(FPIOA_DRIVING_12)},
    {MP_ROM_QSTR(MP_QSTR_DRIVING_13), MP_ROM_INT(FPIOA_DRIVING_13)},
	{MP_ROM_QSTR(MP_QSTR_DRIVING_14), MP_ROM_INT(FPIOA_DRIVING_14)},
	{MP_ROM_QSTR(MP_QSTR_DRIVING_15), MP_ROM_INT(FPIOA_DRIVING_15)},

};
STATIC MP_DEFINE_CONST_DICT(k210_fpioa_locals_dict, k210_fpioa_locals_dict_table);

const mp_obj_type_t k210_fpioa_type = {
	{&mp_type_type},
	.name = MP_QSTR_FPIOA,
	.make_new = k210_fpioa_make_new,
	.locals_dict = (mp_obj_dict_t *)&k210_fpioa_locals_dict,
};
#endif
